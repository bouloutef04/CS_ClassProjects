...
<html lang="en">
    <head>
        ...
        <style>
            <!--
                ...
                h1 { color:yellow; font-size: 1.3em; text-align: center;}
                h2 { color:lime; font-size: 1.2em; text-align: center;}
    ...
    <body>
        <h4>You are connected to the Project 4 Enterprise System database as a <span style="color:red">root-level</span> user</h4>
        <h4>Please enter any SQL query or update command in the box below.</h4>
        <br><br>
        
        <form action="RootCommand" method="post">
            <textarea id="sqlQuery" name="sqlQuery" rows="10" cols="50"></textarea>
            <br><br>
            <div class="center">
            <button name="button" value="submit" id="submit" action="" method="get" type="execute">Execute Command</button>
            <input type="reset" value="Reset Form">
            <button name="button" value="clear" type="clear" value="clear">Clear Results</button>
             </div>
        </form>
